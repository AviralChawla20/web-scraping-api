...
def get_top_hackathon_name_and_logo(url, link):
    ...
    try:
        ...
        hackathon_info["logo_url"] = extract_attribute(
            top_hackathon.find("div", class_="img").find("img"), "src"
        )
...
def scrape_competitions_list(url, num_competitions):
    ...
    try:
        ...
        competition_links = soup.find_all(
            "a", class_="Link__LinkBase-sc-af40de1d-0 lkflLS"
        )
